...
- **API Key Storage**: Your OpenAI API key is stored locally in your browser's storage only
- **Direct API Calls**: Summaries are generated by calling OpenAI directly from your browser
- **No External Servers**: We don't store or process your API key or transcripts on our servers
- **No Data Collection**: No tracking, analytics, or personal data collection
- **Open Source**: Review the code to verify our privacy practices

**Data Usage:**
- Transcripts are processed locally when possible
- API keys are used only for OpenAI API calls
- You can clear browser storage to remove all stored data
